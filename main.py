import gym
import ma_gym
from arguments import common_args, vdn_qmix_args, coma_args, commnet_args
...
if __name__ == '__main__':
	...
	args.episode_limit = env._max_steps  # this might be changed
	...
	if args.alg == 'vdn' or args.alg == 'qmix' or args.alg == 'qtran_base' or args.alg == 'rqn':
		...
		args = coma_args(args)
	elif args.alg.find('vdn') > -1 or args.alg.find('qmix') > -1:  # todo see changed added this else clause
		args = vdn_qmix_args(args)
	else:
